...
export const ContentBrowser = ({
  ...
  const renderFootageContent = () => {
    if (!hasVideos || footageVideos.length === 0) {
      return (
        <div className="content-browser-empty">Place footage files under ./assets/mp4/footage</div>
      );
    }
    return (
      <div className="content-browser-items">
  ...
  const renderShaderContent = () => {
    if (!hasShaders) {
      return <div className="content-browser-empty">Place .glsl files under ./assets/glsl</div>;
    }
    return (
      <div className="content-browser-items">
  ...
  const renderOverlayContent = () => {
    if (overlayVideos.length === 0) {
      return (
        <div className="content-browser-empty">Place overlay files under ./assets/mp4/overlay</div>
      );
    }
    return (
      <div className="content-browser-items">
